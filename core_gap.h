...
__attribute__((always_inline)) __STATIC_INLINE uint32_t __PCCRs_Get(const uint32_t counterId) {
  ...
  switch(counterId) {
      /* CYCLE */
  case  0: __ASM volatile ("csrr %0, 0x780" : "=r" (value)); break;
      /* INSTR */
  case  1: __ASM volatile ("csrr %0, 0x781" : "=r" (value)); break;
      /* LD_STALL */
  case  2: __ASM volatile ("csrr %0, 0x782" : "=r" (value)); break;
      /* JR_STALL */
  case  3: __ASM volatile ("csrr %0, 0x783" : "=r" (value)); break;
      /* IMISS */
  case  4: __ASM volatile ("csrr %0, 0x784" : "=r" (value)); break;
      /* LD */
  case  5: __ASM volatile ("csrr %0, 0x785" : "=r" (value)); break;
      /* ST */
  case  6: __ASM volatile ("csrr %0, 0x786" : "=r" (value)); break;
      /* JUMP */
  case  7: __ASM volatile ("csrr %0, 0x787" : "=r" (value)); break;
      /* BRANCH */
  case  8: __ASM volatile ("csrr %0, 0x788" : "=r" (value)); break;
      /* BTAKEN */
  case  9: __ASM volatile ("csrr %0, 0x789" : "=r" (value)); break;
      /* RVC */
  case 10: __ASM volatile ("csrr %0, 0x78A" : "=r" (value)); break;
  }
